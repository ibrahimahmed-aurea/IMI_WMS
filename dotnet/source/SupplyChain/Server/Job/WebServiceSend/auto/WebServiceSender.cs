...
namespace Imi.Wms.WebServices.ExternalInterface
{
  ...
  public class SenderHandler : System.Web.Services.Protocols.SoapHttpClientProtocol
  {
    ...
    {
      return "Generated on   : 2017-09-08 11:55:41\r\n" +
    ...
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://im.se/wms/webservices/TransportInstruction", RequestNamespace="http://im.se/wms/webservices/", ResponseNamespace="http://im.se/wms/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    ...
    {
      this.Invoke("TransportInstruction", new object[] {
        ChannelId,
        ChannelRef,
        TransactionId,
        aTransportInstructionDoc});
      return;
    }

    public System.IAsyncResult BeginTransportInstruction( string ChannelId, string ChannelRef, string TransactionId, TransportInstructionDoc aTransportInstructionDoc, System.AsyncCallback callback, object asyncState)
    {
      return this.BeginInvoke("TransportInstruction", new object[] {
        ChannelId,
        ChannelRef,
        TransactionId,
        aTransportInstructionDoc}, callback, asyncState);
    }

    public void EndTransportInstruction(System.IAsyncResult asyncResult)
    {
      this.EndInvoke(asyncResult);
    }


    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://im.se/wms/webservices/TransportPlan", RequestNamespace="http://im.se/wms/webservices/", ResponseNamespace="http://im.se/wms/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    ...
    {
      this.Invoke("TransportPlan", new object[] {
        ChannelId,
        ChannelRef,
        TransactionId,
        aTransportPlanHeadDoc});
      return;
    }

    public System.IAsyncResult BeginTransportPlan( string ChannelId, string ChannelRef, string TransactionId, TransportPlanHeadDoc aTransportPlanHeadDoc, System.AsyncCallback callback, object asyncState)
    {
      return this.BeginInvoke("TransportPlan", new object[] {
        ChannelId,
        ChannelRef,
        TransactionId,
        aTransportPlanHeadDoc}, callback, asyncState);
    }

    public void EndTransportPlan(System.IAsyncResult asyncResult)
    {
      this.EndInvoke(asyncResult);
    }
