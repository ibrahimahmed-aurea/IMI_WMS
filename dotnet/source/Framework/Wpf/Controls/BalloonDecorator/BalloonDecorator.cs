...
namespace Imi.Framework.Wpf.Controls
{
    public class BalloonDecorator : Decorator
    {
        ...
        public static readonly DependencyProperty BorderWidthProperty =
            DependencyProperty.Register("BorderWitdh", typeof(double), typeof(BalloonDecorator),
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            Size borderSize = new Size(2 * BorderWidth, 2 * BorderWidth);
        ...
        protected override void OnRender(DrawingContext dc)
        {
            ...
            dc.DrawGeometry(Background, new Pen(BorderBrush, BorderWidth), CreateBalloonGeometry(rect));
