...
using Imi.SupplyChain.ActivityMonitor.UX.Modules.PickZone.Actions;
using Imi.SupplyChain.ActivityMonitor.UX.Modules.PickZone.Constants;
using Imi.SupplyChain.ActivityMonitor.UX.Modules.PickZone.PickZoneMonitor;
using Imi.SupplyChain.ActivityMonitor.UX.Views.ActivityMonitor;

namespace Imi.SupplyChain.ActivityMonitor.UX.Modules.PickZone
{
    public class ModuleController : ModuleControllerBase
    {
        public override void OnShowPickZoneMonitorOverview(object sender, EventArgs e)
        {
            PickZoneMonitorOverviewViewParameters viewParameters = null;
            ...
            if (e is MenuEventArgs)
            {
                ...
                {
                    viewParameters = new PickZoneMonitorOverviewViewParameters();
            ...
            else if (e is DataEventArgs<PickZoneMonitorOverviewViewParameters>)
            {
                viewParameters = ((DataEventArgs<PickZoneMonitorOverviewViewParameters>)e).Data;
            }

            ControlledWorkItem<PickZoneMonitorController> workItem = (from wi in WorkItem.WorkItems.FindByType<ControlledWorkItem<PickZoneMonitorController>>()
            ...
            {
                workItem = WorkItem.WorkItems.AddNew<ControlledWorkItem<PickZoneMonitorController>>();
