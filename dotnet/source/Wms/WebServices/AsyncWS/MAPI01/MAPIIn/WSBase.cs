...
using Imi.Wms.WebServices.MAPIIn.Configuration;
...
namespace Imi.Wms.WebServices.MAPIIn
{
    public class WSBase : System.Web.Services.WebService
    {
        ...
        protected MessageTransaction BeginWebmethod(string mhId, string msgSendId, string objectName)
        {
            string ConnectionString;

            try
            {
                ConnectionString = GetWebConfig(mhId);
            }
            catch (Exception e)
            {
            ...
            MessageTransaction mt = new MessageTransaction(mhId, msgSendId, objectName, db);
        ...
        private string GetWebConfig(string commPartnerId)
        {
