...
namespace Cdc.CodeGeneration.Caching
{
    ...
    {
        public static string Get(HashTypes hashType, string originalString)
        {
            Hash pHash = new Hash();
        ...
        public static bool Verify(HashTypes hashType, string checkString, string hashValue)
        {
            Hash pHash = new Hash();
        ...
        public static bool Verify(HashTypes hashType, string checkString, string hashValue, string saltString)
        {
            Hash pHash = new Hash();
