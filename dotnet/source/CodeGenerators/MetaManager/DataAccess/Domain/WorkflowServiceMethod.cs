...
{
    [ClassStorageHint(TableName = "WorkflowServiceMethod")]
    public class WorkflowServiceMethod : IXmlSerializable, IDomainObject
    {
        public WorkflowServiceMethod()
        {
            IsTransient = true;
        }
        ...
        [PropertyStorageHint(Column = "ServiceMethodId", IsMandatory = true, ForeignKey = "FK_WorkflowSM_Service")]
        public virtual ServiceMethod ServiceMethod { get; set; }

        [DataAccess.DomainXmlById]
        [PropertyStorageHint(Column = "WorkflowId", IsMandatory = true, ForeignKey = "FK_WorkflowSM_Workflow")]
