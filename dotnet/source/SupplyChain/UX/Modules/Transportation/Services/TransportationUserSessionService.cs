...
{
    public class TransportationUserSessionService : ITransportationUserSessionService
    {
        private IUserSessionService userSessionService;

        [InjectionConstructor]
        public TransportationUserSessionService([ServiceDependency] IUserSessionService userSessionService)
        {
