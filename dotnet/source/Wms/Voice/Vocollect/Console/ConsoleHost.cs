...
namespace Imi.Wms.Voice.Vocollect.Console
{
    class ConsoleHost
    {
        ...
        static void Main(string[] args)
        {
            ...
            instance = InstanceFactory.CreateInstance<InstanceBase>("Imi.Wms.Voice.Vocollect", "Imi.Wms.Voice.Vocollect.VocollectInstance", instanceName);
