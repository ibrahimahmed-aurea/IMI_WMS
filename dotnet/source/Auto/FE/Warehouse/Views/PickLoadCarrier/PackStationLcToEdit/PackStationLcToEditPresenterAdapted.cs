...
{
    public class PackStationLcToEditPresenter : PackStationLcToEditPresenterBase
    {
        [InjectionConstructor]
        public PackStationLcToEditPresenter([WcfServiceDependency] IPickLoadCarrierService pickLoadCarrierService)
