...
/*
 * Service Contract for the menu service in the Order Management System service
 * 
 ...
 * Date:   2013-01-31
 */
namespace Imi.SupplyChain.Services.OrderManagement.Menu.ServiceContracts
{
    [ServiceContract(Namespace = "http://Imi.SupplyChain.Services.OrderManagement.Menu.ServiceContracts/2011/09")]
    [ServiceApplicationName("OrderManagement")]
    public interface IGetMenuService
    {
        [OperationContract]
        Response[] GetMenu(GetMenuUSER[] users, bool useDomainInUserID);
    }
}
