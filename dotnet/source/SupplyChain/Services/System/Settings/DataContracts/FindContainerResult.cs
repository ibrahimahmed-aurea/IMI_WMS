...
namespace Imi.SupplyChain.Services.Settings.DataContracts
{
    ...
    public class FindContainerResult : List<Container>
    {
        public FindContainerResult()
        {
        }

        public FindContainerResult(IEnumerable<Container> collection)
            : base(collection)
        {
        }
