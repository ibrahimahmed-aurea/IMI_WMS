...
namespace Imi.SupplyChain.UX.Modules.Abc.Services
{
    public class ABCUserSessionService : IABCUserSessionService
    {
        private IUserSessionService userSessionService;

        [InjectionConstructor]
        public ABCUserSessionService([ServiceDependency] IUserSessionService userSessionService)
        {
