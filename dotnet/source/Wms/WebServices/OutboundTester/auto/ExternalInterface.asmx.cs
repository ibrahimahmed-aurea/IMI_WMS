...
{
  [WebService(Namespace="http://im.se/wms/webservices/", Description="WMS Outbound (Sender) interface 8.0.1 generated on 2017-09-08 11:55:43")]
  ...
  public class InboundInterface : WSBase
  {
    ...
    public void TransportInstruction( string ChannelId, string ChannelRef, string TransactionId, TransportInstructionDoc aTransportInstructionDoc )
    {
      ...
      TransportInstructionInsert aTransportInstructionHandler;

      try
      {
        MessageTransaction mt = BeginWebmethod( ChannelId, ChannelRef, TransactionId, "TI" );

        try
        {
          aTransportInstructionHandler = new TransportInstructionInsert( this );
        }
        catch (Exception e)
        {
          Exception InternalError = new Exception( "InternalError: Building insert handler", e );
        ...
        try
        {
          if ( aTransportInstructionDoc == null )
          {
            Exception InternalError = new Exception( "DataError: Root object cannot be null" );
            throw (InternalError);
          }
          aTransportInstructionHandler.Process( ref mt, null, aTransportInstructionDoc );
          GetDataBase().Commit();
        }
        catch (Exception e)
        {
    ...
    public void TransportPlan( string ChannelId, string ChannelRef, string TransactionId, TransportPlanHeadDoc aTransportPlanHeadDoc )
    {
      ...
      TransportPlanHeadInsert aTransportPlanHeadHandler;

      try
      {
        MessageTransaction mt = BeginWebmethod( ChannelId, ChannelRef, TransactionId, "TP" );

        try
        {
          aTransportPlanHeadHandler = new TransportPlanHeadInsert( this );
        }
        catch (Exception e)
        {
          Exception InternalError = new Exception( "InternalError: Building insert handler", e );
        ...
        try
        {
          if ( aTransportPlanHeadDoc == null )
          {
            Exception InternalError = new Exception( "DataError: Root object cannot be null" );
            throw (InternalError);
          }
          aTransportPlanHeadHandler.Process( ref mt, null, aTransportPlanHeadDoc );
          GetDataBase().Commit();
        }
        catch (Exception e)
        {
