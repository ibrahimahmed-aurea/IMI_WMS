...
using Imi.SupplyChain.Server.WebServices.ExternalInterfaceiRen;
using Imi.SupplyChain.Server.Job.WebServiceSendiRen.PLSQLInterface;
using Imi.Framework.Job;
using Imi.Framework.Job.Data;

namespace Imi.SupplyChain.Server.Job.WebServiceSendiRen
{
    class WebServiceSendiRen : OracleJob
    {
        ...
        public WebServiceSendiRen(string name, bool wait, JobArgumentCollection args)
            : base(name, wait, args)
        {
        }
