...
namespace Imi.CodeGenerators.WebServices.XML2Insert
{
    ...
    class Class1
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Creates and writes C# source code inserts to queue tables");
                ...
                Console.WriteLine("XML2Insert [drive:][path]filename1 [drive:][path]filename2 [drive:][path]filename3 [/msg] [/ns your.namespace]");
                return;
            }
            ...
            InsertGenerator sg = new InsertGenerator(msg, p, ct, aNameSpace);
