/*
  ...
  Generated with Commandline: WEB_SERVICES_3PL WebServices3PL.cs Imi.Wms.WebServices.SyncWS.Interface.c3PL.Order 
  ...
  public partial class WebServices3pl
  {
    ...
    public string _Debug()
    {
      return  "Package        : WEB_SERVICES_3PL\r\n" +
              "Generated on   : 2009-06-05 10:52:13\r\n" +
              "Generated by   : SWG\\olla@IMIPC1091\r\n" +
              "Generated in   : C:\\project\\views\\olla_dotnet_ss\\dotnet\\source\\Wms\\WebServices\\SyncWS\\Wms.WebServices.SyncWS.Interface.c3PL.Order\\Package\r\n";
    }
    ...
    private IDbCommand sp_Findcustomerordertype;
    private IDbCommand sp_Findcustomersbyid;
    private IDbCommand sp_Findmethodofshipmentbyclient;
    ...
    private void CreateSP_Findcustomerordertype()
    {
      OracleParameter  oP;

      sp_Findcustomerordertype = connectionProvider.GetConnection().CreateCommand();
      sp_Findcustomerordertype.CommandText = "WEB_SERVICES_3PL.FINDCUSTOMERORDERTYPE";
      sp_Findcustomerordertype.CommandType = System.Data.CommandType.StoredProcedure;
#if ODP_NET
      ((OracleCommand)sp_Findcustomerordertype).BindByName = true;
#endif

      oP = sp_Findcustomerordertype.CreateParameter() as OracleParameter;
      oP.ParameterName = "CUSTOMER_ORDER_TYPE_CUR_O";
#if ODP_NET
      oP.OracleDbType = OracleDbType.RefCursor;
#else
      oP.OracleType = OracleType.Cursor;
#endif
      oP.Direction = ParameterDirection.Output;
      sp_Findcustomerordertype.Parameters.Add( oP );
    }
    ...
    private void CreateSP_Findmethodofshipmentbyclient()
    {
      IDbDataParameter p;
      OracleParameter  oP;

      sp_Findmethodofshipmentbyclient = connectionProvider.GetConnection().CreateCommand();
      sp_Findmethodofshipmentbyclient.CommandText = "WEB_SERVICES_3PL.FINDMETHODOFSHIPMENTBYCLIENT";
      sp_Findmethodofshipmentbyclient.CommandType = System.Data.CommandType.StoredProcedure;
#if ODP_NET
      ((OracleCommand)sp_Findmethodofshipmentbyclient).BindByName = true;
#endif

      p = sp_Findmethodofshipmentbyclient.CreateParameter();
      p.ParameterName = "CLIENTID_I";
      p.DbType = DbType.String;
      p.Size = 17;
      p.Direction = ParameterDirection.Input;
      sp_Findmethodofshipmentbyclient.Parameters.Add( p );

      oP = sp_Findmethodofshipmentbyclient.CreateParameter() as OracleParameter;
      oP.ParameterName = "METHOD_OF_SHIPMENT_CUR_O";
#if ODP_NET
      oP.OracleDbType = OracleDbType.RefCursor;
#else
      oP.OracleType = OracleType.Cursor;
#endif
      oP.Direction = ParameterDirection.Output;
      sp_Findmethodofshipmentbyclient.Parameters.Add( oP );
    }
    ...
    private void CreateSP_Saveco()
    {
      ...
      p = sp_Saveco.CreateParameter();
      p.ParameterName = "METHODOFSHIPMENTID_I";
      p.DbType = DbType.String;
      p.Size = 17;
      p.Direction = ParameterDirection.Input;
      sp_Saveco.Parameters.Add( p );
      ...
      p = sp_Saveco.CreateParameter();
      p.ParameterName = "CUSTOMERORDERTYPEID_I";
      p.DbType = DbType.String;
      p.Size = 2;
      p.Direction = ParameterDirection.Input;
      sp_Saveco.Parameters.Add( p );
    ...
    public void Findcustomerordertype(out IDataReader         CUSTOMER_ORDER_TYPE_CUR_O)
    {
      if ( sp_Findcustomerordertype == null )
        CreateSP_Findcustomerordertype();

      sp_Findcustomerordertype.Transaction = connectionProvider.CurrentTransaction;

      lock (syncLock)
      {
          currentCommand = sp_Findcustomerordertype;
      }
      // Set In Parameters

      // Execute stored procedure

      sp_Findcustomerordertype.Prepare();
      sp_Findcustomerordertype.ExecuteNonQuery();

      // Set Out Parameters

#if ODP_NET
      CUSTOMER_ORDER_TYPE_CUR_O = (IDataReader)((sp_Findcustomerordertype.Parameters["CUSTOMER_ORDER_TYPE_CUR_O"] as IDbDataParameter).Value as OracleRefCursor).GetDataReader();
#else
      CUSTOMER_ORDER_TYPE_CUR_O = (IDataReader)(sp_Findcustomerordertype.Parameters["CUSTOMER_ORDER_TYPE_CUR_O"] as IDbDataParameter).Value;
#endif
    ...
    public void Findmethodofshipmentbyclient(string                  CLIENTID_I, 
                                             out IDataReader         METHOD_OF_SHIPMENT_CUR_O)
    {
      if ( sp_Findmethodofshipmentbyclient == null )
        CreateSP_Findmethodofshipmentbyclient();

      sp_Findmethodofshipmentbyclient.Transaction = connectionProvider.CurrentTransaction;

      lock (syncLock)
      {
          currentCommand = sp_Findmethodofshipmentbyclient;
      }
      // Set In Parameters

      if ( String.IsNullOrEmpty(CLIENTID_I) )
        (sp_Findmethodofshipmentbyclient.Parameters["CLIENTID_I"] as IDbDataParameter).Value = DBNull.Value;
      else
        (sp_Findmethodofshipmentbyclient.Parameters["CLIENTID_I"] as IDbDataParameter).Value = CLIENTID_I;

      // Execute stored procedure

      sp_Findmethodofshipmentbyclient.Prepare();
      sp_Findmethodofshipmentbyclient.ExecuteNonQuery();

      // Set Out Parameters

#if ODP_NET
      METHOD_OF_SHIPMENT_CUR_O = (IDataReader)((sp_Findmethodofshipmentbyclient.Parameters["METHOD_OF_SHIPMENT_CUR_O"] as IDbDataParameter).Value as OracleRefCursor).GetDataReader();
#else
      METHOD_OF_SHIPMENT_CUR_O = (IDataReader)(sp_Findmethodofshipmentbyclient.Parameters["METHOD_OF_SHIPMENT_CUR_O"] as IDbDataParameter).Value;
#endif
    ...
    public void Saveco(string                  CLIENTID_I, 
                       ...
                       string                  COMARK_I, 
                       string                  STOCKNO_I, 
                       string                  METHODOFSHIPMENTID_I, 
                       string                  CUSTOMERORDERTYPEID_I, 
                       ...
                       string                  PHONE_I)
    {
      ...
      if ( String.IsNullOrEmpty(METHODOFSHIPMENTID_I) )
        (sp_Saveco.Parameters["METHODOFSHIPMENTID_I"] as IDbDataParameter).Value  = DBNull.Value;
      else
        (sp_Saveco.Parameters["METHODOFSHIPMENTID_I"] as IDbDataParameter).Value  = METHODOFSHIPMENTID_I;

      if ( String.IsNullOrEmpty(CUSTOMERORDERTYPEID_I) )
        (sp_Saveco.Parameters["CUSTOMERORDERTYPEID_I"] as IDbDataParameter).Value = DBNull.Value;
      else
        (sp_Saveco.Parameters["CUSTOMERORDERTYPEID_I"] as IDbDataParameter).Value = CUSTOMERORDERTYPEID_I;
      ...
      if ( String.IsNullOrEmpty(NAME1_I) )
        (sp_Saveco.Parameters["NAME1_I"] as IDbDataParameter).Value               = DBNull.Value;
      else
        (sp_Saveco.Parameters["NAME1_I"] as IDbDataParameter).Value               = NAME1_I;

      if ( String.IsNullOrEmpty(NAME2_I) )
        (sp_Saveco.Parameters["NAME2_I"] as IDbDataParameter).Value               = DBNull.Value;
      else
        (sp_Saveco.Parameters["NAME2_I"] as IDbDataParameter).Value               = NAME2_I;

      if ( String.IsNullOrEmpty(ADR1_I) )
        (sp_Saveco.Parameters["ADR1_I"] as IDbDataParameter).Value                = DBNull.Value;
      else
        (sp_Saveco.Parameters["ADR1_I"] as IDbDataParameter).Value                = ADR1_I;

      if ( String.IsNullOrEmpty(ADR2_I) )
        (sp_Saveco.Parameters["ADR2_I"] as IDbDataParameter).Value                = DBNull.Value;
      else
        (sp_Saveco.Parameters["ADR2_I"] as IDbDataParameter).Value                = ADR2_I;

      if ( String.IsNullOrEmpty(ADR3_I) )
        (sp_Saveco.Parameters["ADR3_I"] as IDbDataParameter).Value                = DBNull.Value;
      else
        (sp_Saveco.Parameters["ADR3_I"] as IDbDataParameter).Value                = ADR3_I;

      if ( String.IsNullOrEmpty(POSTCODE_I) )
        (sp_Saveco.Parameters["POSTCODE_I"] as IDbDataParameter).Value            = DBNull.Value;
      else
        (sp_Saveco.Parameters["POSTCODE_I"] as IDbDataParameter).Value            = POSTCODE_I;

      if ( String.IsNullOrEmpty(CITY_I) )
        (sp_Saveco.Parameters["CITY_I"] as IDbDataParameter).Value                = DBNull.Value;
      else
        (sp_Saveco.Parameters["CITY_I"] as IDbDataParameter).Value                = CITY_I;

      if ( String.IsNullOrEmpty(COUNTRY_I) )
        (sp_Saveco.Parameters["COUNTRY_I"] as IDbDataParameter).Value             = DBNull.Value;
      else
        (sp_Saveco.Parameters["COUNTRY_I"] as IDbDataParameter).Value             = COUNTRY_I;

      if ( String.IsNullOrEmpty(PHONE_I) )
        (sp_Saveco.Parameters["PHONE_I"] as IDbDataParameter).Value               = DBNull.Value;
      else
        (sp_Saveco.Parameters["PHONE_I"] as IDbDataParameter).Value               = PHONE_I;
                           ...
                           string                  PRODLOTREQ_I)
    {
      ...
      if ( String.IsNullOrEmpty(BLOCKCOD_I) )
        (sp_Savecoline.Parameters["BLOCKCOD_I"] as IDbDataParameter).Value        = DBNull.Value;
      else
        (sp_Savecoline.Parameters["BLOCKCOD_I"] as IDbDataParameter).Value        = BLOCKCOD_I;

      if ( String.IsNullOrEmpty(SERIAL_I) )
        (sp_Savecoline.Parameters["SERIAL_I"] as IDbDataParameter).Value          = DBNull.Value;
      else
        (sp_Savecoline.Parameters["SERIAL_I"] as IDbDataParameter).Value          = SERIAL_I;

      if ( String.IsNullOrEmpty(SERNUMB_I) )
        (sp_Savecoline.Parameters["SERNUMB_I"] as IDbDataParameter).Value         = DBNull.Value;
      else
        (sp_Savecoline.Parameters["SERNUMB_I"] as IDbDataParameter).Value         = SERNUMB_I;

      if ( String.IsNullOrEmpty(PRODLOT_I) )
        (sp_Savecoline.Parameters["PRODLOT_I"] as IDbDataParameter).Value         = DBNull.Value;
      else
        (sp_Savecoline.Parameters["PRODLOT_I"] as IDbDataParameter).Value         = PRODLOT_I;

      if ( String.IsNullOrEmpty(PROMOTN_I) )
        (sp_Savecoline.Parameters["PROMOTN_I"] as IDbDataParameter).Value         = DBNull.Value;
      else
        (sp_Savecoline.Parameters["PROMOTN_I"] as IDbDataParameter).Value         = PROMOTN_I;

      if ( String.IsNullOrEmpty(STORBAT_I) )
        (sp_Savecoline.Parameters["STORBAT_I"] as IDbDataParameter).Value         = DBNull.Value;
      else
        (sp_Savecoline.Parameters["STORBAT_I"] as IDbDataParameter).Value         = STORBAT_I;

      if ( String.IsNullOrEmpty(PRODLOTREQ_I) )
        (sp_Savecoline.Parameters["PRODLOTREQ_I"] as IDbDataParameter).Value      = DBNull.Value;
      else
        (sp_Savecoline.Parameters["PRODLOTREQ_I"] as IDbDataParameter).Value      = PRODLOTREQ_I;
