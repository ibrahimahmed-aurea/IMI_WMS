...
namespace Imi.Framework.Messaging.Transform
{
    ...
    public abstract class XslTransformComponentBase : PipelineComponent
    {
        ...
        /// <summary>
        /// 	<para>Initializes an instance of the <see cref="XslTransformComponentBase"/> class.</para>
        /// </summary>
        /// <param name="configuration">
        /// Configuration properties.
        /// </param>
        protected XslTransformComponentBase(PropertyCollection configuration)
            : base(configuration)
        {
        ...
        /// <summary>
        /// Caches and compiles the specified stylesheet. 
        /// If the stylesheet is already compiled it will be fetched from cache.
        /// </summary>
