...
if %1X == X goto usage
if %2X == X goto usage
installservice %1 Imi.Wms.Mobile.Server Imi.Wms.Mobile.Server.ServerInstance %2
goto end

:usage
echo. 
echo Installs a IMI iWMS Thin Client Server instance as a Windows Service.
echo. 
