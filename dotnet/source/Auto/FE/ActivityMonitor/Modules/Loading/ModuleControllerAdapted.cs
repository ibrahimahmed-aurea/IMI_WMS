...
using Imi.SupplyChain.ActivityMonitor.UX.Modules.Loading.Actions;
using Imi.SupplyChain.ActivityMonitor.UX.Modules.Loading.Constants;
using Imi.SupplyChain.ActivityMonitor.UX.Modules.Loading.LoadingMonitor;
using Imi.SupplyChain.ActivityMonitor.UX.Views.ActivityMonitor;
using Imi.SupplyChain.UX.Infrastructure;

namespace Imi.SupplyChain.ActivityMonitor.UX.Modules.Loading
{
    public class ModuleController : ModuleControllerBase
    {
        public override void OnShowLoadingMonitorOverview(object sender, EventArgs e)
        {
            LoadingMonitorOverviewViewParameters viewParameters = null;
            ...
            if (e is MenuEventArgs)
            {
                ...
                {
                    viewParameters = new LoadingMonitorOverviewViewParameters();
            ...
            else if (e is DataEventArgs<LoadingMonitorOverviewViewParameters>)
            {
                viewParameters = ((DataEventArgs<LoadingMonitorOverviewViewParameters>)e).Data;
            }

            ControlledWorkItem<LoadingMonitorController> workItem = (from wi in WorkItem.WorkItems.FindByType<ControlledWorkItem<LoadingMonitorController>>()
            ...
            {
                workItem = WorkItem.WorkItems.AddNew<ControlledWorkItem<LoadingMonitorController>>();
