...
{
    public class PackStationToLCPresenter : PackStationToLCPresenterBase
    {
        [InjectionConstructor]
        public PackStationToLCPresenter([WcfServiceDependency] IPickLoadCarrierService pickLoadCarrierService)
