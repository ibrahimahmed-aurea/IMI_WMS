    ...
    class Class1
    {
        ...
        static void Main(string[] args)
        {
            ...
            if ((aPackFileName == null) || (aStructDescFileName == null) || (aOutFileName == null))
            {
                ...
                Console.WriteLine("XML2Struct [drive:][path]filename1 [drive:][path]filename2 [drive:][path]filename3 [/msg] [/ns your.namespace]");
                return;
            }
            ...
            StructureGenerator sg = new StructureGenerator(msg, p, ct, aNameSpace);
