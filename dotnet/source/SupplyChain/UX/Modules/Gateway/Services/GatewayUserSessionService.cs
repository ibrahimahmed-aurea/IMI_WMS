...
namespace Imi.SupplyChain.UX.Modules.Gateway.Services
{
    public class GatewayUserSessionService : IGatewayUserSessionService
    {
        private IUserSessionService userSessionService;

        [InjectionConstructor]
        public GatewayUserSessionService([ServiceDependency] IUserSessionService userSessionService)
        {
