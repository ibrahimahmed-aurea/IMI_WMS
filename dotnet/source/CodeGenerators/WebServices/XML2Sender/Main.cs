...
namespace Imi.CodeGenerators.WebServices.XML2Sender
{
    ...
    class Class1
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Creates and writes C# source code that calls a web service.");
                ...
                Console.WriteLine("XML2Sender [drive:][path]filename1 [drive:][path]filename2 [drive:][path]filename3 [/msg]");
                return;
            }
            ...
            SenderGenerator sg = new SenderGenerator(msg, p, ct, aNameSpace);
