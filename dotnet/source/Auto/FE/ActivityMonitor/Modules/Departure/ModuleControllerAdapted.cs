...
using Imi.SupplyChain.ActivityMonitor.UX.Modules.Departure.Actions;
using Imi.SupplyChain.ActivityMonitor.UX.Modules.Departure.Constants;
using Imi.SupplyChain.ActivityMonitor.UX.Modules.Departure.DepartureMonitor;
using Imi.SupplyChain.ActivityMonitor.UX.Views.ActivityMonitor;


namespace Imi.SupplyChain.ActivityMonitor.UX.Modules.Departure
{
