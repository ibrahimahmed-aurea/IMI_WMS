...
using Imi.SupplyChain.UX.Modules.Abc;

namespace Imi.SupplyChain.UX.Modules.Abc.Views.ChooseDefaultWarehouse
{
    public class ChooseDefaultWarehousePresenter : AsyncDataPresenter<IAuthenticationService, IChooseDefaultWarehouseView>
    {
        ...
        [ServiceDependency]
        public IABCUserSessionService UserSessionService
        {
            get;
            set;
        }
