...
/*
 * Service Contract for the configuration service in the Order Management System service
 * 
 ...
 * Date:   2013-01-31
 */
namespace Imi.SupplyChain.Services.OrderManagement.Guiconfiguration.ServiceContracts
{
    [ServiceContract(Namespace = "http://Imi.SupplyChain.Services.OrderManagement.Guiconfiguration.ServiceContracts/2011/09")]
    [ServiceApplicationName("OrderManagement")]
    public interface IGetGuiconfigurationService
    {
        [OperationContract]
        Response[] GetGuiconfiguration(GetGuiconfigurationUSER[] users, bool useDomainInUserID);
    }
}
