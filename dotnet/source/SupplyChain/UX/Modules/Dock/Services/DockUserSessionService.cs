...
namespace Imi.SupplyChain.UX.Modules.Dock.Services
{
    public class DockUserSessionService : IDockUserSessionService
    {
        private IUserSessionService userSessionService;

        [InjectionConstructor]
        public DockUserSessionService([ServiceDependency] IUserSessionService userSessionService)
        {
